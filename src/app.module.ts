...
import { CreatePostUseCaseSymbol, GetPostsUseCaseSymbol } from './modules/Forum/useCases/post/utils/symbols';
...
@Module({
  ...
  controllers: [CreatePostController, UserCreateController, LoginUserController, GetPostsController],
  providers: [
    PrismaService,
    JwtService,
    AuthService,
